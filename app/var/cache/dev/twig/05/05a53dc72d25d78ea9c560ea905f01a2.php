...
/* header.html.twig */
class __TwigTemplate_15bb0a4b339b63733e540c61786dab2c extends Template
{
    private $source;
    private $macros = [];
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("IS_AUTHENTICATED_FULLY")) {
           ...
           ";
            ...
            if ((isset($context["userDetails"]) || array_key_exists("userDetails", $context) ? $context["userDetails"] : (function () { throw new RuntimeError('Variable "userDetails" does not exist.', 6, $this->source); })())) {
                // line 7
                yield "                <span>You are logged in as <a href=\"";
                yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_details");
                yield "\">";
...
";
    ...
    {
        return array (  90 => 18,  84 => 15,  80 => 14,  77 => 13,  73 => 11,  65 => 9,  55 => 7,  52 => 6,  50 => 5,  47 => 4,  45 => 3,  41 => 1,);
    }
    ...
    {% if is_granted('IS_AUTHENTICATED_FULLY') %}
        <div >
           {% set userDetails = app.user.details %}
            {% if userDetails %}
                <span>You are logged in as <a href=\"{{ path('user_details')}}\">{{ userDetails.name }}</a>, <a href=\"{{ path('app_logout') }}\">Logout</a></span>
            {% else %}
                <span>You are logged in as <a href=\"{{ path('user_details')}}\">no-name user</a>, <a href=\"{{ path('app_logout') }}\">Logout</a></span>
            {% endif %}
        </div>
    {% else %}
        <div >
...
", "header.html.twig", "/media/sofiya/KINGSTON/project1/templates/header.html.twig");
    }
}
